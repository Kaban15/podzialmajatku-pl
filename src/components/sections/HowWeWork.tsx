...
const triggerClass =
  "w-full justify-start text-left px-6 py-5 text-[15px] font-medium rounded-none border-0 border-b border-slate-200 border-l-4 border-l-transparent bg-transparent data-[state=active]:bg-white data-[state=active]:border-l-[#0088cc] data-[state=active]:shadow-none hover:bg-slate-100 data-[state=active]:text-[#0088cc] text-slate-600 m-0 outline-none focus:ring-0 transition-none";
...
export function HowWeWork() {
  return (
    <section className="max-w-7xl mx-auto w-full mb-32 px-4 mt-12">
      ...
      >
        {/* LEFT COLUMN — menu */}
        <TabsList className="md:col-span-4 flex flex-col w-full h-full bg-slate-50 p-0 m-0 rounded-none border-r border-slate-200 justify-start items-stretch">
        ...
        <div className="md:col-span-8 w-full h-full p-8 md:p-14 bg-white m-0">
