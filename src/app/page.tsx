    ...
    <>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="space-y-6">
            <h1 className="font-serif text-3xl font-bold tracking-tight text-body sm:text-4xl lg:text-5xl">
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <h2 className="mb-8 font-serif text-2xl font-bold tracking-tight text-body sm:text-3xl md:text-4xl">
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <h2 className="mb-4 font-serif text-2xl font-bold tracking-tight text-body sm:text-3xl md:text-4xl">
            Dlaczego warto wybrać Kancelarię Lexperiens?
          </h2>
